...
This is a **[Codecademy](https://www.codecademy.com/learn)** Web Development Path - BackEnd - Express - **[Boss Machine Project](https://www.codecademy.com/paths/web-development/tracks/javascript-back-end-development/modules/express-cumulative-project/informationals/bapi-p4-boss-machine)**.

In this project I have only worked on the **server.js** file and the files in the **server folder**.
All the other code was provided by Codecademy.
